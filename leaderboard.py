...
class Leaderboard():
	...
	def draw(self, screen):
		...
		for nomeJogador, pontosJogador in lista:
			...
			Config.draw_text(screen, str(idx)+"."+nomeJogador, Config.font2, Config.BRANCO, 245-12, 140+80*idx)
			Config.draw_text(screen, Leaderboard.alinhado(pontosJogador), Config.font2, Config.AMARELO, 235+600-12, 140+80*idx)
			idx += 1
